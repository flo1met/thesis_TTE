...
files <- data.frame(path = list.files("Simulation 1/out/measures", full.names = TRUE)) %>%
  extract(
    col     = path,
...
for (n_value in ns) {
  ...
  ggsave(paste0("Simulation 1/out/plots/plots_coverage",n_value,".png"), plots_coverage, 
...
for (n_value in ns) {
  ...
  ggsave(paste0("Simulation 1/out/plots/plots_width",n_value,".png"), plots_coverage, 
         width = 21, height = 29.7, units = "cm", dpi = 300)
...
for (n_value in ns) {
  ...
  ggsave(paste0("Simulation 1/out/plots/plots_power",n_value,".png"), plots_coverage, 
         width = 21, height = 29.7, units = "cm", dpi = 300)
...
for (n_value in ns) {
  ...
  ggsave(paste0("Simulation 1/out/plots/plots_bias_coverage",n_value,".png"), plots_coverage, 
         width = 21, height = 29.7, units = "cm", dpi = 300)
...
ggsave("Simulation 1/out/plots/plots_PE_bias.png", plots_coverage, 
       width = 21, height = 29.7, units = "cm", dpi = 300)
...
# Save the combined plot
ggsave("Simulation 1/out/plots/plots_PE_MSE.png", plots_coverage, 
       width = 21, height = 29.7, units = "cm", dpi = 300)
...
for (n_value in ns) {
  ...
  ggsave(paste0("Simulation 1/out/plots/plots_PE",n_value,".png"), plots_coverage, 
         width = 21, height = 29.7, units = "cm", dpi = 300)
