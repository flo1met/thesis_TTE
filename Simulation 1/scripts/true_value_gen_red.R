...
#save(true_value_conf_red, file = "Simulation 1/out/True Values/true_value_conf_red_low.rda")
...
#save(true_value_treat_red, file = "Simulation 1/out/True Values/true_value_treat_red_low.rda")