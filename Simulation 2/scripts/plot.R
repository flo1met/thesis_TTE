...
ggsave("Simulation 2/out/plots/noCI_performance.png", combined_noCI, width = 10, height = 4, dpi = 300)
...
ggsave("Simulation 2/out/plots/CI_performance.png", combined_CI, width = 10, height = 4, dpi = 300)
