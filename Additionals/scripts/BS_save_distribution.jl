...
df = Arrow.Table("Additionals/datasets/data_200_-3.8_0.5_1.arrow") |> DataFrame
...
CSV.write("Additionals/out/BS_sample_200.csv", df_200)
...
df = Arrow.Table("Additionals/datasets/data_1000_-3.8_0.5_1.arrow") |> DataFrame
...
CSV.write("Additionals/out/BS_sample_1000.csv", df_1000)
...
df = Arrow.Table("Additionals/datasets/data_5000_-3.8_0.5_1.arrow") |> DataFrame
...
CSV.write("Additionals/out/BS_sample_5000.csv", df_5000)
