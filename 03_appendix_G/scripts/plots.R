...
df_200 <- read.csv("03_appendix_G/out/BS_sample_200.csv")
...
ggsave(filename = "03_appendix_G/out/plot_BSdist_200.png", width = 10, height = 6, dpi = 300)


df_1000 <- read.csv("03_appendix_G/out/BS_sample_1000.csv")
...
ggsave(filename = "03_appendix_G/out/plot_BSdist_1000.png", width = 10, height = 6, dpi = 300)


df_5000 <- read.csv("03_appendix_G/out/BS_sample_5000.csv")
...
ggsave(filename = "03_appendix_G/out/plot_BSdist_5000.png", width = 10, height = 6, dpi = 300)
